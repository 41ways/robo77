...
| 2~9 | 그대로 더한다 | 각 3장 |
| 10 | 그대로 더한다 | 8장 |
| 0 | 합은 그대로. 그래서 언제 내도 안전하다 | 4장 |
| 11·22·33·44·55·66 | 그냥 더한다. 합이 0일 때 내면 곧바로 11의 배수 (-11 이면 0이 되어 산다) | 각 1장 |
| -10 | 10을 뺀다. 합이 9 이하면 음수가 된다 | 4장 |
| 76 | 76을 더한다. 언제든 낼 수 있지만, 합이 쌓인 뒤에 내면 제가 터진다 | 1장 |
| ×2 | **다음 사람이 두 장**을 내야 한다. 합은 안 변한다 | 4장 |
| 방향전환 | 방향을 뒤집는다. **합을 안 바꿔서 언제 내도 안전** | 5장 |
